                    ...
                    response.forEach((emp) => {
                        ...
                        empBlock.innerHTML = `
                            <div class="grow">
                                ...
                                <div class="text-[10px] text-gray-600 flex justify-between mt-1 leading-none tracking-wide px-2.5 pt-1 border-t border-gray-600"><p>{{ $client_company->name }}</p><p>SparkPair</p></div>
                            </div>
                        `;
