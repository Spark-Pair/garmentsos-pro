    ...
    <section class="text-center mx-auto ">
        <div
            ...
            @if (in_array(Auth::user()->role, ['developer', 'owner', 'admin', 'accountant', 'customer']))
                <div class="absolute bottom-14 right-3 flex items-center gap-2 w-fll z-50">
                    ...
                    <div class="card_container px-3 pb-3 h-full flex flex-col">
                        ...
                        <div id="calc-bottom" class="flex w-full gap-4 text-sm bg-[var(--secondary-bg-color)] pt-2 rounded-lg">
                            <div class="total-Amount flex justify-between items-center border border-gray-600 rounded-lg py-2 px-4 w-full cursor-not-allowed">
                                <div>Total Net Amount - Rs.</div>
                                <div class="text-right">0.0</div>
                            </div>
                            <div class="balance-order flex justify-between items-center border border-gray-600 rounded-lg py-2 px-4 w-full cursor-not-allowed">
                                <div>Total Balance Order - Pcs</div>
...
<script>
        window.__ordersIndex = {
            ...
            printOpenOrder: @json(request()->boolean('print_order')),
